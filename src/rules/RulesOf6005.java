...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // If the code is written by yourself or your team, you may use it
	    if (writtenByYourself) {
	        return true;
	    }
	    
	    // If the assignment specifically asks for an implementation, you can't use external code
	    if (implementationRequired) {
	        return false;
	    }
	    
	    // For external code: it must be publicly available, properly cited, and not from past coursework
